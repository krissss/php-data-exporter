...
class TypedExpression
{
    ...
    public function getSpoutType(): int
    {
        return [
            self::TYPE_NUMERIC => SpoutDataType::TYPE_NUMERIC,
            self::TYPE_STRING => SpoutDataType::TYPE_STRING,
            self::TYPE_FORMULA => SpoutDataType::TYPE_FORMULA,
            self::TYPE_EMPTY => SpoutDataType::TYPE_EMPTY,
            self::TYPE_BOOLEAN => SpoutDataType::TYPE_BOOLEAN,
            self::TYPE_DATE => SpoutDataType::TYPE_DATE,
            self::TYPE_ERROR => SpoutDataType::TYPE_ERROR,
        ][$this->type] ?? SpoutDataType::TYPE_STRING;
    }
